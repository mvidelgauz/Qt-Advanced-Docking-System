...
This branch ("CentralWidgetEmulation - private_aggregate") combines all other changes I did in other branches to form a version that I need for my application.
